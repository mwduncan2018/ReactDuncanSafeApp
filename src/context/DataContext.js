...
export const DataProvider = ({ children }) => {
    ...
    const [products, setProducts] = useState([
        ...
        { id: 3, manufacturer: "McDonalds", model: "Chicken McGriddle", price: 3.0, numberInStock: 25 },
        { id: 4, manufacturer: "Wendys", model: "Bacon Double Stack", price: 3.0, numberInStock: 2 },
